                  ...
                  <div className="p-4 space-y-4">
                    ...
                    {appPreview.screens[activeScreen].keyElements.map((element, i) => (
                      ...
                      >
                        ...
                        />
                        <span className="text-xs text-muted-foreground line-clamp-2">{element}</span>
                      </div>
                    ))}
        ...
        <CardContent>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {appPreview.keyFeatures.map((feature, index) => (
              <div
                key={index}
                className="p-4 rounded-xl border border-border bg-secondary/30 hover:bg-secondary/50 transition-colors hover-scale"
              >
        ...
        <CardContent className="p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button 
              ...
              className="gap-2"
            >
              <RefreshCw className="w-4 h-4" /> Regenerate Preview
            </Button>
            <Button 
              size="lg" 
